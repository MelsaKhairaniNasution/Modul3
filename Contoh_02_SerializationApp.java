...
public class Contoh_02_SerializationApp {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        demo.serialize(participants, "d:/B_16650052/Modul 03/participantData.ser");
        System.out.println("Serialization is Done\n");

        System.out.println("Deserialize Object...");
        List<Contoh_02_Participant> newList = demo.deserialize("d:/B_16650052/Modul 03/participantData.ser");
